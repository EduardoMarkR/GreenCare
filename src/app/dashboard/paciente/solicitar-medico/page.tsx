  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#F7F4E7]">
        ...
        <CannaPageHero
        badge="Cadastro profissional"
        title="Solicitar cadastro como médico"
        description="Preencha seus dados profissionais para que a administração possa analisar seu perfil e liberar o acesso ao painel médico."
